"""Experiment 05 — Cross-plane coupling: sub-656228 / ses-1245548523.
...
against the already-downloaded acq-1245937736 (144 µm depth, 27 ROIs).
...
Usage:
    python experiments/dandi_000871_05_ses1245548523.py

Outputs:
    data/dandi/triage/000871/crossplane_coupling_sub656228_ses1245548523.json
    data/dandi/triage/000871/crossplane_coupling_sub656228_ses1245548523.md
    data/dandi/triage/000871/crossplane_coupling_sub656228_ses1245548523.log
"""
...
# acq-1245937727: 53 ROIs, VISp,  148 µm (just downloaded)
_PLANE_A_REL = f"{_SUBJECT}/{_SUBJECT}_{_SESSION}-acq-1245937727_image+ophys.nwb"
# acq-1245937736: 27 ROIs, VISpm, 144 µm (previously available)
_PLANE_B_REL = f"{_SUBJECT}/{_SUBJECT}_{_SESSION}-acq-1245937736_image+ophys.nwb"
...
# ---------------------------------------------------------------------------
# Window helpers — identical to exp03/exp04
# ---------------------------------------------------------------------------
...
def _write_summary(path: Path, results: dict, subject: str, session: str) -> None:
    lines = [
        f"# Cross-plane Coupling Summary: DANDI 000871 — {subject} / {session}",
        "",
