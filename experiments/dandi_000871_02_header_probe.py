"""Experiment 02 — Header probe: open each ready 000871 NWB file and record metadata.
...
Usage:
    python experiments/dandi_000871_02_header_probe.py
"""
...
def main() -> None:
    ...
    from dandi_analysis.dataset_000871.index import parse_subject_session
    from dandi_analysis.dataset_000871.metadata import extract_nwb_metadata

    print("=" * 60)
    print("Experiment 02 - Header Probe: DANDI 000871")
    print("=" * 60)
