"""Experiment 01 — Inventory: discover all local DANDI 000871 NWB files.

Usage:
    python experiments/dandi_000871_01_inventory.py
"""
...
def main() -> None:
    ...
    print("=" * 60)
    print("Experiment 01 - NWB Inventory: DANDI 000871")
    print("=" * 60)
    ...
    for ep in _EXPECTED_PATHS:
        role = _ROLES.get(Path(ep).stem.rsplit("_image", 1)[0], "unknown")
