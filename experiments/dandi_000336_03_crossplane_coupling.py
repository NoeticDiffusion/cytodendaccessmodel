...
Requires both pair_a files:
  sub-644972_ses-1237338784-acq-1237809217_ophys.nwb  (shallow, 6 ROIs)
  sub-644972_ses-1237338784-acq-1237809219_ophys.nwb  (deep,    62 ROIs)

Usage:
    python experiments/dandi_000336_03_crossplane_coupling.py

Outputs:
    data/dandi/triage/000336/crossplane_coupling.json
    data/dandi/triage/000336/crossplane_coupling.md
    data/dandi/triage/000336/crossplane_coupling.log
"""
...
_SHALLOW_REL = "sub-644972/sub-644972_ses-1237338784-acq-1237809217_ophys.nwb"
_DEEP_REL    = "sub-644972/sub-644972_ses-1237338784-acq-1237809219_ophys.nwb"
...
def _load_dff_and_intervals(path: Path):
    """Return (dff_array, timestamps, interval_dict) from a 000336 NWB file."""
...
def _write_summary(path: Path, results: dict) -> None:
    lines = [
        "# Cross-plane Coupling Summary: DANDI 000336",
        "",
...
def main() -> None:
    ...
    _emit(log_lines, "=" * 60)
    _emit(log_lines, "Experiment 03 - Cross-plane Coupling: DANDI 000336")
    _emit(log_lines, "=" * 60)
