...
from dandi_analysis.dataset_000871.io import safe_read_session_metadata
...
def parse_subject_session(path: Path) -> tuple[str, str]:
    """Extract subject_id and session_label from a canonical 000871 NWB path.

    000871 paths look like:
